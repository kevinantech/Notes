    ...
    /*
        ...
        console.log(number);    
        console.log(Math.round(number));    // --> Retorna un numero redondeado a su entero mas cercano.
    */
    /*
        let num = 5.5;
        console.log(Math.floor(num));   // --> Retorna el piso aproximado de un numero.
        console.log(Math.ceil(num));    // --> Retorna el techo aproximado de un numero.
        console.log(Math.trunc(num));   // --> Retorna la parte entera de un numero, eliminando las partes fraccionarias.
    */
    /*
